...
export default function ContactOverlay() {
  ...
  // State untuk melacak link sosial media mana yang sedang di-hover
    ...
    <AnimatePresence>
      {isContactOpen && (
        <>
          ...
          {/* Kotak Contact (Tidak full height, h-auto) */}
          <motion.div
            initial={{ x: '100%' }}
            animate={{ x: 0 }}
            exit={{ x: '100%' }}
          ...
          >
            <div className="p-8 md:p-10 flex flex-col">
              ...
              <div className="flex justify-between items-start mb-6">
                ...
                {/* Tombol Action Kanan Atas */}
                <div className="flex items-center gap-2 shrink-0 ml-4">
                  <button
                    onClick={closeContact}
                    className="bg-black text-white px-3 py-1.5 text-xs font-mono uppercase flex items-center hover:bg-black/80 transition-colors tracking-widest"
                  >
                    CLOSE[x]
                  </button>
              ...
              {/* Sub-judul / Deskripsi */}
              <p className="text-sm font-medium mb-12 max-w-sm leading-relaxed text-black/90">
                If you have a project in mind, we&rsquo;d love to hear about it.<br />
                We typically respond within 5 business days.
              </p>

              {/* Bagian Tengah: Profil Julie */}
              <div className="border-t border-black/10 py-6">
                <div className="grid grid-cols-[120px_1fr_1.5fr] gap-6">
                  {/* Foto dengan Dot Putih */}
                  <div 
                    className="relative w-[120px] h-[120px] bg-gray-400 grayscale bg-cover bg-center shadow-inner"
                  ...
                  {/* Nama */}
                  <div className="uppercase text-[11px] font-mono tracking-wide pt-1">
                    Julie Pilon
                  </div>
                  ...
                  <div className="uppercase text-[11px] font-mono tracking-wide flex flex-col justify-between pt-1">
                    ...
                    <div className="mt-auto">
                      <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="hover:italic transition-all cursor-pointer inline-block">
                  ...
                  <div className="flex flex-col gap-2">
                    {SOCIAL_LINKS.map((s) => (
                      <a
                        ...
                        className="cursor-pointer hover:italic transition-all inline-block w-max"
                      >
                        {/* Jika state sesuai dengan label ini, tampilkan panah, jika tidak tampilkan spasi kosong */}
